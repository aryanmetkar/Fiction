...
import com.example.myapplication.Adapters.ActorsListAdapter;
import com.example.myapplication.Adapters.CategoryEachFilmListAdapter;
...
public class DetailActivity extends AppCompatActivity {
    ...
    private RecyclerView recyclerViewActors,recyclerViewCatgory;
        ...
        mStringRequest = new StringRequest(Request.Method.GET, "https://moviesapi.ir/api/v1/movies/" + idFilm, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (item.getGenres() !=null){
                    ...
                    recyclerViewCatgory.setAdapter(adapterCategory);
                }
    ...
    private void initView() {
        ...
        recyclerViewCatgory = findViewById(R.id.genreView);
        recyclerViewActors = findViewById(R.id.imagesRecycler);

        recyclerViewActors.setLayoutManager(new LinearLayoutManager(this,LinearLayoutManager.HORIZONTAL,false));
        recyclerViewCatgory.setLayoutManager(new LinearLayoutManager(this,LinearLayoutManager.HORIZONTAL,false));
